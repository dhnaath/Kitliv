...
export function FlowView({ currentTab, onBack, onSelectTab, onNavigate, onUnavailable }: { currentTab: string, onBack: () => void, onSelectTab?: (tab: string) => void, onNavigate: (view: string) => void, onUnavailable?: () => void }) {
  ...
  if (!currentTab) {
    return (
      <div className="flex flex-col min-h-screen bg-[#121212] relative">
        ...
        <ScrollContainer id="flow-view-main" className="flex-1 overflow-y-auto p-6 pb-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:auto-rows-max md:content-start">
  ...
  if (currentTab === 'cat_liabilitas') {
    return (
      <div className="flex flex-col min-h-screen bg-[#121212] relative">
        ...
        <ScrollContainer id="flow-view-cat-liabilitas" className="flex-1 overflow-y-auto p-6 pb-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:auto-rows-max md:content-start">
  ...
  if (currentTab === 'cat_pengeluaran') {
    return (
      <div className="flex flex-col min-h-screen bg-[#121212] relative">
        ...
        <ScrollContainer id="flow-view-cat-pengeluaran" className="flex-1 overflow-y-auto p-6 pb-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:auto-rows-max md:content-start">
  ...
  if (currentTab === 'cat_kredit') {
    return (
      <div className="flex flex-col min-h-screen bg-[#121212] relative">
        ...
        <ScrollContainer id="flow-view-cat-kredit" className="flex-1 overflow-y-auto p-6 pb-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:auto-rows-max md:content-start">
  ...
  if (currentTab === 'cat_pajak') {
    return (
      <div className="flex flex-col min-h-screen bg-[#121212] relative">
        ...
        <ScrollContainer id="flow-view-cat-pajak" className="flex-1 overflow-y-auto p-6 pb-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:auto-rows-max md:content-start">
  ...
  if (currentTab === 'cat_otomatisasi') {
    return (
      <div className="flex flex-col min-h-screen bg-[#121212] relative">
        ...
        <ScrollContainer id="flow-view-cat-otomatisasi" className="flex-1 overflow-y-auto p-6 pb-20 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:auto-rows-max md:content-start">
  ...
  if (currentTab === 'monthly_burden') return <div className="p-4 text-gray-100 flex items-center gap-3 pt-6"><button onClick={() => onSelectTab?.('cat_liabilitas')}><ArrowLeft size={24}/></button>Estimasi Beban Bulanan is currently unavailable.</div>;
