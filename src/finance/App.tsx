...
export default function App() {
  ...
  return (
    <div className="bg-[#121212] text-gray-100 min-h-screen font-sans w-full min-h-screen relative overflow-x-hidden" id="app-root">
      <AnimatePresence mode="wait">
        ...
        {activeScreen === 'settings' && (
          <motion.div 
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.2 }}
            className="w-full h-full min-h-screen z-50 bg-[#1a1a1a]"
          >
        ...
        {activeScreen === 'new_transaction' && (
          <motion.div 
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.2 }}
            className="w-full h-full min-h-screen z-50 bg-[#121212]"
          >
