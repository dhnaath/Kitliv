        ...
        <>
          ...
          >
            <div className="flex items-center justify-between px-6 pt-6 pb-4 shrink-0">
              <h2 className="text-xl font-bold text-slate-900 mx-auto">{title}</h2>
              <button 
                onClick={onClose}
                className="absolute right-6 w-8 h-8 flex items-center justify-center bg-slate-200 hover:bg-gray-300 rounded-full text-slate-500 transition-colors"
              >
                <X size={18} />
              </button>
            </div>
