...
export const DateInlineInput = ({ date, onChange, highlight }: { date: Date | null, onChange: (isoDate: string) => void, highlight: boolean }) => {
  ...
  return (
    <input
      ...
      placeholder={'-'}
      className={`w-full h-full min-h-[38px] p-2 bg-transparent text-center focus:outline-none focus:bg-indigo-50 transition-colors text-slate-900 font-semibold placeholder:text-[#004f71] placeholder:font-bold`}
    />
  );
};
